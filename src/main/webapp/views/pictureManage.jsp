...
%>
    ...
    <link href="${APP_PATH}/css/base.css" type="text/css" rel="stylesheet">
    <link href="${APP_PATH}/css/tab.css" type="text/css" rel="stylesheet">
    <link href="${APP_PATH}/css/item.css" type="text/css" rel="stylesheet">
    <link href="${APP_PATH}/css/item_do.css" type="text/css" rel="stylesheet">
    <link rel="stylesheet" href="${APP_PATH}/css/uploadify.css" type="text/css"></link>
    ...
    <script type="text/javascript" src="${APP_PATH}/static/js/jquery.uploadify.v2.0.3.js"></script>
    <script type="text/javascript" src="${APP_PATH}/static/js/swfobject.js"></script>

<script type="text/javascript">
   
	var url = "${APP_PATH}/pictures";
	var method;
	...
	function formatProPic(val, row) {
		return "<img width=100 height=100 src='${APP_PATH}/" + val + "'>";
	}
...
<body style="margin:1px;" id="ff">
	<table id="dg" title="图片信息管理" class="easyui-datagrid" pagination="true"
	       ...
	       url="${APP_PATH}/pictures/datagrid?type=<%=type %>&grade=<%=grade %>"
	       toolbar="#tb">

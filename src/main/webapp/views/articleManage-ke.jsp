...
<link rel="stylesheet" href="${APP_PATH}/kindeditor-4.1.10/themes/default/default.css"/>
<script charset="utf-8" src="${APP_PATH}/kindeditor-4.1.10/kindeditor-all.js"></script>
<script charset="utf-8" src="${APP_PATH}/kindeditor-4.1.10/lang/zh_CN.js"></script>

<script type="text/javascript">
   
	var url = "${APP_PATH}/articles";
	var method;
	...
	function formatHref(val, row) {
		return "<a href='${APP_PATH}/article.html?id="
...
<body style="margin:1px;" id="ff">
	...
	<table id="dg" title="文本信息管理" class="easyui-datagrid" pagination="true"
	       ...
	       url="${APP_PATH}/articles/datagrid" toolbar="#tb">

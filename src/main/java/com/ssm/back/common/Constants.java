...
public class Constants {
	...
	public static final String ARTICLE_CACHE_KEY = "management:article:";// 文章key
	public static final String PICTURE_CACHE_KEY = "management:picture:";// 图片key
